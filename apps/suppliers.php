  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <!-- right column -->
        ...
        <p>This page only Encodes List of Suppliers.</p>
      </div>
          <!-- Horizontal Form -->
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Encode / Update Supplier Form</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="username" name="username" placeholder="Name (Veraza)" required/>
                  </div>
                </div>
                <div class="form-group">
                  <label for="text" class="col-sm-2 control-label" required/>Contact</label>

                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="contact" name="contact" placeholder="+639/0955...." required>
                  </div>
                </div>
                 <div class="form-group">
                  <label for="text" class="col-sm-2 control-label" required/>Address</label>

                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="address" name="address" placeholder="Address(Balibago, Sta. Rosa)" required>
                  </div>
                </div>
                <div class="form-group">
                  <label for="text" class="col-sm-2 control-label" required/>Email</label>

                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="email" name="email" placeholder="supplier@yaho.com" required>
                  </div>
                </div>
        ...
        <p>This form Deletes a Supplier Name/Details in the List.</p>
      </div>
        <div class="box box-danger">
            <div class="box-header with-border">
              <h3 class="box-title">Delete Supplier Form</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="username2" id="username2" placeholder="User Name (Veraza)">
                  </div>
                </div>
