...
function showPurchase(str,date_range,merchandiser)
{
 console.log("I am at showPurchase function!");
   if (str == "") {
        ...
        xmlhttp.open("GET","manage/showPurchase.php?supplier="+str+"&date="+date_range+"&merchandiser="+merchandiser,true);
        xmlhttp.send();
    }
}
</script>
       ...
       <!-- right column -->
        <div class="col-md-6"> 
          <div class="box box-primary">
            <div class="box-header with-border">
             ...
             <div class="form-group">
              ...
              <div class="form-group">
                ...
                <select class="form-control select2" style="width: 100%;" name="merchandiser" id="merchandiser">
              ...
              <div class="form-group">
                ...
                <select class="form-control select2" style="width: 100%;" name="supplier" id="supplier" onchange="showPurchase(this.value,datepicker.value,merchandiser.value)">
            ...
            <!-- /.box-header -->
            <div class="box box-primary" id="demo">
      ...
      <!-- /.box -->
       ...
       <div class="box">
            <div class="box-header">
              <h3 class="box-title">List of Items Ordered.</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
