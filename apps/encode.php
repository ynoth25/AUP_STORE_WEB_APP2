  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <!-- right column -->
        ...
        <p>This page only Encodes List of Computers details like <b>OS, HDD</b> usage and etc. will be added if the service App is installed.</p>
      </div>
          <!-- Horizontal Form -->
            ...
            <!-- form start -->
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="computername" name="computername" placeholder="Computer Name (ICTS001-PC)">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="department" name="department" placeholder="Department Name (Accounting / COD)">
                  </div>
                </div>
                <div class="form-group">
                  <label for="text" class="col-sm-2 control-label">Code</label>

                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="deptcode" name="deptcode"  placeholder="Code (CONLVL01 / COD01)">
                  </div>
                </div>
                <div class="form-group">
                  <label for="text" class="col-sm-2 control-label">Property#</label>

                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="propertynumber"  name="propertynumber"  placeholder="Property # (123-011)">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="nameofuser" name="nameofuser" placeholder="Name of User (Arvin Ramos) ">
                  </div>
                </div>
                <div class="form-group">
...
<script>
    ...
    <script>
        ...
        <p>This form Deletes a Computer Name/Details in the List. Just Encode Computer if Accidentally deleted.</p>
      </div>
            ...
            <!-- form start -->
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="computername2" id="computername2" placeholder="Computer Name (ICTS001-PC)">
                  </div>
                </div>
        ...
        $(document).ready(function(){
            $("#delete").click(function(){
                var computername = $('#computername2').val();
         
                $.ajax({
                    url:'computers/delete.php',
                    method:'POST',
                    data:{
                        computername:computername
