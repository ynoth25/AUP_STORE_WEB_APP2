...
function showReq()
{
        ...
        xmlhttp.open("GET","manage/showReq.php?",true);
        xmlhttp.send();
      ...
      <ol class="breadcrumb">
       ...
       <div class="box">
            <div class="box-header">
              <h3 class="box-title">List of Items to be Encoded.</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              ...
              $query5 = ("Select prod_code,prod_desc,physical_count,users.name from req_prod_encode
                        INNER JOIN users on users.user_id = req_prod_encode.request_by");
              ...
              <table id="example1" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    ...
                    ?> 
                        <tr>
                            ...
                            <td><button type="submit" id="search" name="search" class="btn btn-info pull-left" >Encoded</button></td>
                        </tr>
