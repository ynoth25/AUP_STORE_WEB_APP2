...
function showUser(str) {
    if (str == "") {
        ...
        xmlhttp.open("GET","computers/load.php?q="+str,true);
        xmlhttp.send();
    }
...
function showHdd(str)
{
  if (str == "") {
        ...
        xmlhttp.open("GET","computers/hdd.php?q="+str,true);
        xmlhttp.send();
    }
}
...
function showRemarks(str)
{
  if (str == "") {
        ...
        xmlhttp.open("GET","computers/remarks.php?q="+str,true);
        xmlhttp.send();
    }
}
...
function showSoftware(str)
{
  if (str == "") {
        ...
        xmlhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
                document.getElementById("software").innerHTML = this.responseText;
            }
        };
        xmlhttp.open("GET","computers/software.php?q="+str,true);
        xmlhttp.send();
    }
}
</script>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="form-group">
                <label>Select</label>
                <select class="form-control select2" style="width: 100%;" name="users" onchange="showUser(this.value);showHdd(this.value);showSoftware(this.value);showRemarks(this.value)">
                  <option selected="selected">Computer Name</option>
                  <option value="2">ICTS01</option>
                  <option value="1">ADMIN01</option>
                   <option value="3">CGS-EDUC</option>
        ...
        <div class="col-md-6">         
        <div class="box box-primary" id="hdd">
        ...
        <div class="box box-primary" id="software">
