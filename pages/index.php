...
<div class="lockscreen-wrapper">
  <div class="lockscreen-logo">
    <a href="../index2.html"><b>ICTS</b>PMM</a>
  </div>
  <!-- User name -->
  ...
  <div class="lockscreen-item">
    ...
    <form class="lockscreen-credentials" action="layout/dashboard.php">
      <div class="input-group">
         <input type="text" class="form-control" placeholder="Username" border=1px>
         </div>
         <br>
         <div class="input-group">
